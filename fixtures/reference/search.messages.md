...
[`search:read`](https://docs.slack.dev/reference/scopes/search.read.md)
...
**Rate Limits**[Tier 2: 20+ per minute](https://docs.slack.dev/apis/web-api/rate-limits.md)
...
We recommend using the [Real-time Search API](https://docs.slack.dev/apis/web-api/real-time-search-api.md) ([`assistant.search.context`](https://docs.slack.dev/reference/methods/assistant.search.context.md) method) instead.
