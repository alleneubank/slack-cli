---
title: "apps.datastore.get API method"
summary: "Get an item from a datastore"
url: "https://docs.slack.dev/reference/methods/apps.datastore.get"
type: "reference"
subtype: "method"
method_name: "apps.datastore.get"
http_method: "POST"
rate_limit: "t4"
scopes:
  bot: ["datastore:read"]
...
[`datastore:read`](https://docs.slack.dev/reference/scopes/datastore.read.md)
...
**Rate Limits**[Tier 4: 100+ per minute](https://docs.slack.dev/apis/web-api/rate-limits.md)
...
This method is only available for [workflow apps](https://docs.slack.dev/workflows.md).
...
Refer to [Datastores](https://docs.slack.dev/tools/deno-slack-sdk/guides/using-datastores.md) for more information.
